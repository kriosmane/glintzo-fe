        ...
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2 ">
            <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48  ">
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                    ...
                    <h2 class="text-5xl font-bold tracking-tight text-gray-900 leading-[60px]">Grazie per il tuo interesse
                    </h2>
                    <p class="mt-6  font-bold text-xl leading-8 text-black">Hai i requisiti necessari per finalizzare la tua
                        iscrizione alla lista d'attesa di<br>
                        Glintzo!
                    </p>
                    <p class="text-base mt-4 leading-6 text-black">Completa il Form e selezionare la casella "Sono
                        disponibile per
                        una call" per avere la possibilità di approfondire il funzionamento della piattaforma direttamente
                        con uno dei co-founder.
                    </p>
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <fieldset>
                                ...
                                <legend class="text-base font-semibold leading-6 text-gray-900">Area geografica di lavoro
                                </legend>
                                        ...
                                        <span class="flex flex-1">
                                            <span class="flex flex-col">
                                                <span id="project-type-0-label"
                                                    class="block text-sm font-medium text-gray-900">Milano</span>
                                            </span>
                                        </span>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div>
                                <label class="text-base font-semibold text-gray-900">Svolgo questa attività perchè</label>
                                ...
                                <fieldset class="mt-4">
                                    ...
                                    <div class="space-y-4 sm:flex sm:items-center sm:space-x-10 sm:space-y-0">
                                        <div class="flex items-center">
                                            ...
                                            <label class="ml-3 block text-xs font-normal leading-6 text-gray-900">É la mia
                                                professione</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input value="personal" name="userType" type="radio" v-model="state.userType"
                                                class="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-600">
                                            <label class="ml-3 block text-xs font-normal leading-6 text-gray-900">É il mio
                                                hobby</label>
                                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div>
                                <label class="text-base font-semibold text-gray-900">Sono disponibile per una call</label>
                                    ...
                                    <div class="space-y-4 sm:flex sm:items-center sm:space-x-10 sm:space-y-0">
                                        <div class="flex items-center">
                                            <input value="si" name="call" type="radio" v-model="state.call"
                                                class="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-600">
                                            <label class="ml-3 block text-xs font-normal leading-6 text-gray-900">Si</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input value="no" name="call" type="radio" v-model="state.call"
                                                class="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-600">
                                            <label class="ml-3 block text-xs font-normal leading-6 text-gray-900">No</label>
                                        </div>
